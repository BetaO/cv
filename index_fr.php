...
<head>
    ...
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="assets/css/pillar.css">
			    ...
			    <div class="media flex-column flex-md-row">
				    ...
				    <div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
					    <div class="primary-info">
						    <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">Oualid Betari</h1>
						    <div class="title mb-3">Docteur en Informatique</div>
						    <ul class="list-unstyled">
							    <li class="mb-2"><a href="mailto:beta.oualid@gmail.com"><i class="far fa-envelope fa-fw mr-2" data-fa-transform="grow-3"></i>beta.oualid@gmail.com</a></li>
							    <li class="mb-2"><i class="fas fa-mobile-alt fa-fw mr-2" data-fa-transform="grow-6"></i>+212 6 43 16 49 70</li>
								<li><i class="fas fa-map-marker-alt fa-fw mr-2" data-fa-transform="grow-3"></i>Oujda, Maroc</li>
						    </ul>
					    </div><!--//primary-info-->
					    <div class="secondary-info ml-md-auto mt-2">
						    <ul class="resume-social list-unstyled">
				                <li class="mb-3"><a href="https://www.researchgate.net/profile/Oualid_Betari"><span class="fa-container text-center mr-2"><i class="fab fa-researchgate fa-fw"></i></span>researchgate.net/profile/Oualid_Betari</a></li>
								<li class="mb-3"><a href="https://www.linkedin.com/in/oualid-betari/"><span class="fa-container text-center mr-2"><i class="fab fa-linkedin-in fa-fw"></i></span>linkedin.com/in/stevedoe</a></li>
				                <li class="mb-3"><a href="https://github.com/BetaO"><span class="fa-container text-center mr-2"><i class="fab fa-github-alt fa-fw"></i></span>github.com/BetaO</a></li>
				                <li class="mb-3"><a href="https://twitter.com/BetaOualid"><span class="fa-container text-center mr-2"><i class="fab fa-twitter fa-fw"></i></span>@BetaOualid</a></li>
